...
import Header from "../component/Header"; // Ensure path is correct
    ...
    <div className="contact-section">
      ...
      <div className="social-links">
        ...
        <a href="https://www.linkedin.com/in/ubaid-ur-rehman-5851b22b4/" target="_blank" rel="noopener noreferrer">
          <Image src="/linkdin.jpg" alt="LinkedIn" width={50} height={50} />
        </a>
        <a href="https://wa.me/923354273216?text=Hello%20Ubaid%2C%20I%20want%20to%20discuss%20a%20project%20with%20you!" target="_blank" rel="noopener noreferrer">
          <Image src="/whatsapp.jpg" alt="WhatsApp" width={50} height={50} />
        </a>
      </div>
